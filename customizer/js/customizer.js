...
function swithcerMenu() {
    if ($('.customizer-box').length) {
        ...
        $(".customizer-box #boxed").on('click', function() {
            ...
            Cookies.set('boxed-layout', 'boxed', {
                expires: 365,
                path: '/'
            });
        ...
        $(".customizer-box #full-box").on('click', function() {
            ...
            Cookies.set('boxed-layout', 'full-width', {
                expires: 365,
                path: '/'
            });
        });
        ...
        $('#styleOptions .color1').on('click', function() {
            ...
            Cookies.set('logo-img-light', 'skin/color1/img/logo-light.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('logo-img-dark', 'skin/color1/img/logo.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('price-icon', 'skin/color1/img/price-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('404-icon', 'skin/color1/img/404-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('map-skin', 'skin-1', {
                expires: 365,
                path: '/'
            });
        });
        ...
        $('#styleOptions .color2').on('click', function() {
            ...
            Cookies.set('logo-img-light', 'skin/color2/img/logo-light.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('logo-img-dark', 'skin/color2/img/logo.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('price-icon', 'skin/color2/img/price-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('404-icon', 'skin/color2/img/404-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('map-skin', 'skin-2', {
                expires: 365,
                path: '/'
            });
        });
        ...
        $('#styleOptions .color3').on('click', function() {
            ...
            Cookies.set('logo-img-light', 'skin/color3/img/logo-light.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('logo-img-dark', 'skin/color3/img/logo.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('price-icon', 'skin/color3/img/price-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('404-icon', 'skin/color3/img/404-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('map-skin', 'skin-3', {
                expires: 365,
                path: '/'
            });
        });
        ...
        $('#styleOptions .color4').on('click', function() {
            ...
            Cookies.set('logo-img-light', 'skin/color4/img/logo-light.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('logo-img-dark', 'skin/color4/img/logo.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('price-icon', 'skin/color4/img/price-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('404-icon', 'skin/color4/img/404-icon.png', {
                expires: 365,
                path: '/'
            });
            Cookies.set('map-skin', 'skin-4', {
                expires: 365,
                path: '/'
            });
        });
